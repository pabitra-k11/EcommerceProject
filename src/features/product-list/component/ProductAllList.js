...
const sortOptions = [
  ...
  { name: "Discount wise", href: "#", current: false },
];
...
export default function ProductAllList() {
  ...
  const handleFilter=(e)=>{
    setFilter((currData)=>{
      return {...currData,[e.target.name]:e.target.defaultValue}
    });
                        ...
                        <div className="grid grid-cols-1 mt-6 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div key={product.id} className="relative border-2 border-solid rounded-md group">
                                ...
                                <div className="flex justify-between mt-4">
                                  <div className="p-2">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 ">
                                      <StarIcon className="inline w-6 h-6 text-yellow-600 align-bottom"/>
                                      {product.rating}
                                    </p>
                                  </div>
                                   <div className="p-2"> 
