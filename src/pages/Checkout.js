  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className='lg:col-span-3'>
         <form className='px-5 py-12 mt-12 bg-white'>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between px-5 py-5 mb-2 border-2 border-gray-200 border-solid gap-x-6">
       ...
       <div className="px-0 mx-auto mt-12 bg-white border max-w-7xl sm:px-0 lg:px-0">
